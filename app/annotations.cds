using { minhwanhwang_22_STUDENTH22Srv } from '../srv/service.cds';

annotate minhwanhwang_22_STUDENTH22Srv.CustomerMessages with @UI.HeaderInfo: { TypeName: 'Customer Message', TypeNamePlural: 'Customer Messages', Title: { Value: customerMessageID } };
annotate minhwanhwang_22_STUDENTH22Srv.CustomerMessages with {
  ID @UI.Hidden @Common.Text: { $value: customerMessageID, ![@UI.TextArrangement]: #TextOnly }
};
annotate minhwanhwang_22_STUDENTH22Srv.CustomerMessages with @UI.Identification: [{ Value: customerMessageID }];
annotate minhwanhwang_22_STUDENTH22Srv.CustomerMessages with {
...
annotate minhwanhwang_22_STUDENTH22Srv.CustomerMessages with @UI.LineItem: [
...
annotate minhwanhwang_22_STUDENTH22Srv.CustomerMessages with @UI.FieldGroup #Main: {
...
annotate minhwanhwang_22_STUDENTH22Srv.CustomerMessages with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];

annotate minhwanhwang_22_STUDENTH22Srv.CustomerMessages with @UI.SelectionFields: [
  customerMessageID
];
