 ...
 * @Before(event = { "READ" }, entity = "minhwanhwang_22_STUDENTH22Srv.CustomerMessage")
...
try {
    ...
    customerMessages = await SELECT.from('minhwanhwang_22_STUDENTH22.CustomerMessage').forUpdate();
} catch (error) {
